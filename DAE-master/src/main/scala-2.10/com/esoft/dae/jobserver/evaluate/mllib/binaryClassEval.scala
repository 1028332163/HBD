package com.esoft.dae.jobserver.evaluate.mllib
...
object binaryClassEval extends SparkJob {
  type JobData = Seq[String]
  type JobOutput = Unit

  def runJob(sc: SparkContext, runtime: JobEnvironment, args: JobData): JobOutput = {
    com.esoft.dae.evaluate.mllib.binaryClassEval.exec(sc, args.toArray)
  }
