...
/**
  * @author liuzw
  */
class RfRgs(taskId: String) extends BaseDao(taskId) {
  def execRandomForest(sc: SparkContext, basePath: String, inputPath: String,
                       ...
                       minInstancesPerNode: String, alPath: String, numTrees: String, predictionCol: String,
                       seed: String, subsamplingRate: String,
    ...
    dfToUse.show()
    //checkin,seed没有设置
    val model: RandomForestRegressionModel = new RandomForestRegressor()
...
object RfRgs {
  ...
  def exec(sc: SparkContext, args: Array[String]): Unit = {
    ...
    val executer = new RfRgs(args.last)
    try {
      ...
      executer.execRandomForest(sc: SparkContext, basePath: String, inputPath: String,
        checkpointInterval: String, featureSubsetStrategy: String, featuresCol: String,
        impurity: String, labelCol: String, maxBins: String, maxDepth: String, minInfoGain: String,
        minInstancesPerNode: String, alPath: String, numTrees: String, predictionCol: String,
        seed: String, subsamplingRate: String,
